...
export default {
    computed: {
        //quando temos outros valores computados, precisamos usar o spread ...
        ...mapGetters({
            //colocando o nome do getter na variavel total
            total: 'valorTotal'
        }),
        //total() {
            //retornando o valor total dos produtos via getters
            //return this.$store.getters.valorTotal
        //},
        produtos() {
            //retornando o array de produtos do estado da store
